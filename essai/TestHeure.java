...
import temps.Heure;
import temps.ExceptionMauvaiseValeurPourHeure;
import temps.ExceptionMauvaiseValeurPourMinute;
...
public class TestHeure
{
    ...
    public void test4uneHeureDePlus() {
        ...
        h2.uneHeureDePlus();
        assertEquals("01h56", h2.toString());
        h1.uneHeureDePlus();
        assertEquals("15h57", h1.toString());
        h1.uneHeureDePlus();
        assertEquals("16h57", h1.toString());
    }
}

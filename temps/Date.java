...
public class Date implements Comparable<Date> {
    private int jour; //commentaire jusqu'a fin ligne
    private int mois; /* Commentaire millieu texte */
    private int annee;
    /**
     ...
     * Construit une Date en donnant des valeurs aux variables d'instance de l'objet Date
     * 
     * @param texte une chaine decaractères au format jj/mm/aaaa
     * 
     * @exception ExceptionMauvaisJour exception indiquant si le jour est icorrect (parexemple <=0 ou >31)
     * @exception ExceptionMauvaisMois exception indiquant si le mois est icorrect (parexemple <=0 ou >12)
     * @exception ExceptionMauvaiseAnnee exception indiquant si l'année est icorrecte (parexemple <0)
    ...
    /**
     * Convertit la date en chaine notant cette date
     * 
     * @param texte une chaine de caractères au format jj/mm/aaaa
     */
     ...
     * 
     * @param a un entier précisant l'année à laquelle on s'interesse
     * 
     * @return vrai si l'année est bisextile, faux dans le cas contraire
     * 
     * @since version 2
     */
     ...
     * 
     * @return une chaine de caractères qui est le nom du mois en français
     */
    ...
    /**
     * compare l'objet courant (la date considérée) à une autre date
     * 
     * @param autreDate une instance de la classe Date à comparer
     * 
     * @return un entier nul si les deux dates sont égales,<br/>
     * un entier positif si la date considérée est posterieure à autreDate,<br/>
     * un entier négatif si la date considérée est anterieure à autreDate
     * 
